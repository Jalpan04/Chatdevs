...
![A screenshot of the Cardamom chat interface, showing the CLI theme, a list of users, and the main chat log.]
<img width="910" height="678" alt="Screenshot 2025-10-20 094505" src="https://github.com/user-attachments/assets/ea8a0706-6eb0-4bdb-a3a0-0d9855081c55" />
...
Installation
 * Clone the repository (or just save the file):
